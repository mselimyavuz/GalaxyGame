...
class MainWidget(RelativeLayout):
    ...
    def init_audio(self):
        ...
        self.sound_begin.volue = .25
        self.sound_gameover_voice.volue = .25
        self.sound_gameover_impact.volue = .6
        self.sound_galaxy.volue = .25
        self.sound_restart.volue = .25
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            ...
            while self.current_offset_y >= spacing_y:
                ...
                self.score_txt = "SCORE: " + str(self.current_y_loop*100)
                self.generate_tiles_coordinates()
